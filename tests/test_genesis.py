...
class TestCreateBaseContextFile:
    ...
    def test_create_base_context_file_creates_file(
...
class TestGetPrNumber:
    ...
    @mock.patch("personaforge.genesis.utils.run_command")
    def test_get_pr_number(self, mock_run: mock.MagicMock) -> None:
    ...
    @mock.patch("personaforge.genesis.utils.run_command")
    def test_get_pr_number_empty_output(self, mock_run: mock.MagicMock) -> None:
...
class TestOpenPr:
    ...
    @mock.patch("personaforge.genesis.utils.run_command")
    def test_open_pr(self, mock_run: mock.MagicMock) -> None:
...
class TestMain:
    ...
    def test_main_returns_pull_request_info(
        self,
        mock_create_file: mock.MagicMock,
        ...
        Args:
            mock_create_file: Mock for create_base_context_file.
            mock_open: Mock for open_pr.
            mock_run: Mock for run_command.
    ...
    def test_main_switches_back_to_original(
        self, mock_run: mock.MagicMock, mock_switch: mock.MagicMock
    ) -> None:
